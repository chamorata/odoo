...
class TestProductAttributeValueConfig(TestProductAttributeValueCommon):
    ...
    def test_product_filtered_exclude_for(self):
        ...
        self.assertTrue(self.computer._get_variant_for_combination(
            computer_ssd_256 + computer_ram_8 + computer_hdd_1)._is_variant_possible())
        self.assertFalse(
            self.computer._get_variant_for_combination(computer_ssd_256 + computer_ram_16 + computer_hdd_1))
        self.assertFalse(
            self.computer._get_variant_for_combination(computer_ssd_512 + computer_ram_16 + computer_hdd_1))
    ...
    def test_children_product_filtered_exclude_for(self):
        ...
        self.assertFalse(
            self.computer_case._get_variant_for_combination(computer_size_m)._is_variant_possible(computer_hdd_4))
    ...
    def test_is_combination_possible(self):
        ...
        # CASE: parent ok
        self.assertTrue(
            self.computer._is_combination_possible(computer_ssd_256 + computer_ram_8 + computer_hdd_1, mouse_color_red))
        self.assertTrue(
            mouse._is_combination_possible(mouse_color_red, computer_ssd_256 + computer_ram_8 + computer_hdd_1))
        ...
        self.assertFalse(
            mouse._is_combination_possible(mouse_color_green, computer_ssd_256 + computer_ram_8 + computer_hdd_1))
    ...
    def test_get_first_possible_combination(self):
        ...
        self.assertEqual(self.computer._get_first_possible_combination(),
        ...
        computer_ram_32.write({
            'exclude_for': [(0, computer_ram_32.exclude_for.id, {
                'product_tmpl_id': self.computer.id,
                'value_ids': [(6, 0, [computer_hdd_1.id, computer_hdd_2.id, computer_hdd_4.id, computer_ssd_256.id,
                                      computer_ssd_512.id])]
            })]
        })
        ...
        self.assertEqual(mouse._get_first_possible_combination(
            parent_combination=computer_ssd_256 + computer_ram_8 + computer_hdd_1), mouse_color_green)
        ...
        self.assertEqual(mouse._get_first_possible_combination(necessary_values=mouse_color_yellow),
    ...
    def test_get_closest_possible_combinations(self):
        ...
        self.assertEqual(self.computer._get_closest_possible_combination(
    ...
    def test_inactive_related_product_update(self):
        ...
        self.assertEqual(product_attribut.number_related_products, 1,
        ...
        self.assertEqual(product_attribut.number_related_products, 0,
