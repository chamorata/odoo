...
class TestWorkEntryHolidaysMultiContract(TestWorkEntryHolidaysBase):
    ...
    def test_multi_contract_holiday(self):
        ...
        leave = self.create_leave(datetime(2015, 11, 17), datetime(2015, 11, 20), name="Doctor Appointment",
        ...
        work = work_entries.filtered(
            lambda line: line.work_entry_type_id == self.env.ref('hr_work_entry.work_entry_type_attendance'))
        ...
        self.assertEqual(sum(leave.mapped('duration')), 28,
