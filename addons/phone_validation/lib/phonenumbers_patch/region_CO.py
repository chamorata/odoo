...
PHONE_METADATA_CO = PhoneMetadata(id='CO', country_code=57, international_prefix='00(?:4(?:[14]4|56)|[579])',
                                  ...
                                  fixed_line=PhoneNumberDesc(
                                      national_number_pattern='601055(?:[0-4]\\d|50)\\d\\d|6010(?:[0-4]\\d|5[0-4])\\d{4}|60(?:[124-7][2-9]|8[1-9])\\d{6}',
                                      example_number='6012345678', possible_length=(10,),
                                      possible_length_local_only=(7,)),
                                  mobile=PhoneNumberDesc(
                                      national_number_pattern='333301[0-5]\\d{3}|3333(?:00|2[5-9]|[3-9]\\d)\\d{4}|(?:3(?:24[1-9]|3(?:00|3[0-24-9]))|9101)\\d{6}|3(?:0[0-5]|1\\d|2[0-3]|5[01]|70)\\d{7}',
                                  ...
                                  intl_number_format=[NumberFormat(pattern='(\\d{3})(\\d{7})', format='\\1 \\2',
                                                                   leading_digits_pattern=['6']),
                                                      NumberFormat(pattern='(\\d{3})(\\d{7})', format='\\1 \\2',
                                                                   leading_digits_pattern=['3[0-357]|91']),
                                                      NumberFormat(pattern='(\\d)(\\d{3})(\\d{7})',
