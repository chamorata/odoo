...
>
    ...
    <xsl:template name="first_page_graphics_corporation">
        ...
        <drawRightString x="20cm" y="28.5cm">
            <xsl:value-of select="//corporate-header/corporation/rml_header1"/>
        </drawRightString>
        <drawString x="1cm" y="27cm">
            <xsl:value-of select="//corporate-header/corporation/street"/>
        </drawString>
        ...
        <drawRightString x="7cm" y="26cm">
            <xsl:value-of select="//corporate-header/corporation/phone"/>
        </drawRightString>
        <drawString x="1cm" y="25.5cm">Mail:</drawString>
        <drawRightString x="7cm" y="25.5cm">
            <xsl:value-of select="//corporate-header/corporation/email"/>
        </drawRightString>
        ...
        <drawCentredString x="10.5cm" y="0.8cm">Your contact :
    ...
    <xsl:template name="other_pages_graphics_corporation">
        ...
        <setFont name="Helvetica" size="10"/>
        <drawRightString x="1cm" y="27.5cm">
            <xsl:value-of select="//corporate-header/corporation/rml_header1"/>
        </drawRightString>
        <drawString x="1cm" y="27cm">
            <xsl:value-of select="//corporate-header/corporation/street"/>
