...
class StockMove(models.Model):
    ...
    def _generate_valuation_lines_data(self, partner_id, qty, debit_value, credit_value, debit_account_id,
        ...
        if self.product_id.cost_method == 'standard':
            ...
            component_cost = abs(
                currency.round(sum(subcontract_production.move_raw_ids.stock_valuation_layer_ids.mapped('value'))))
        ...
        # `stock_input` account as it adds directly to the value of the subcontracted product
            ...
            rslt['credit_line_vals']['account_id'] = self.product_id.product_tmpl_id.get_product_accounts()[
                'stock_input'].id
        return rslt
