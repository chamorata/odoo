...
class TestProjectTaskQuickCreate(TestProjectCommon):
    ...
    def test_create_task_with_valid_expressions(self):
        ...
        valid_expressions = {
            ...
            'task A 30H   2.5h #Tag1 #tag2     #tag3    @Armande      @Bast @raouf1 @raouf2': ('task A 30H   2.5h', 3,
                                                                                               4, "0", 0),
            ...
            'task A 30H 2.5h #Tag1 #tag2 #tag3 @Armande @Bastttt @raouf1 @raouf2 !': ('task A 30H 2.5h @Bastttt', 3, 3,
                                                                                      "1", 0),
