...
class TestResourceCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        # UTC+6
        cls.calendar_patel = cls._define_calendar('38 Hours',
                                                  sum([((9, 12, i, 3 / 7), (13, 17, i, 4 / 7)) for i in range(5)], ()),
                                                  'Etc/GMT-6')
        # UTC-8 winter, UTC-7 summer
        cls.calendar_john = cls._define_calendar('8+12 Hours', [(8, 16, 1, 1), (8, 13, 4, 5 / 12), (16, 23, 4, 7 / 12)],
                                                 'America/Los_Angeles')
        # UTC+1 winter, UTC+2 summer
        ...
        cls.calendar_paul = cls._define_calendar('Morning and evening shifts',
                                                 sum([((2, 7, i, 0.5), (10, 16, i, 0.5)) for i in range(5)], ()),
                                                 'America/Noronha')

        cls.calendar_bob = cls._define_calendar('Calendar with adjacent attendances',
