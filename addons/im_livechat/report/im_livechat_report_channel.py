...
class ImLivechatReportChannel(models.Model):
    ...
    time_to_answer = fields.Float('Time to answer (sec)', digits=(16, 2), readonly=True, aggregator="avg",
    ...
    nbr_message = fields.Integer('Average message', readonly=True, aggregator="avg",
    ...
    days_of_activity = fields.Integer('Days of activity', aggregator="max", readonly=True,
