                ...
                invoice_line_ids=[
                    {
                        'price_unit': 100.0,
                        'tax_ids': [Command.set(
                            (self._get_tax_by_xml_id('s_iva10b') + self._get_tax_by_xml_id('s_req014')).ids)],
                    },
                    {
                        'price_unit': 50.0,
                        'tax_ids': [Command.set(
                    ...
                    },
                    {
                        'price_unit': 200.0,
                        'tax_ids': [Command.set(
                            (self._get_tax_by_xml_id('s_iva21s') + self._get_tax_by_xml_id('s_req52')).ids)],
                    },
                ],
            )
            invoice.action_post()
                ...
                invoice_line_ids=[
                    {
                        'price_unit': 100.0,
                        'tax_ids': [
                            (6, 0, (self._get_tax_by_xml_id('p_iva10_bc') + self._get_tax_by_xml_id('p_irpf19')).ids)],
                    },
                    {
                        'price_unit': 200.0,
                        'tax_ids': [
                            (6, 0, (self._get_tax_by_xml_id('p_iva21_sc') + self._get_tax_by_xml_id('p_irpf19')).ids)],
                    },
                ],
            )
            invoice.action_post()
    ...
    def test_100_in_refund_p_iva10_bc(self):
        ...
        with freeze_time(self.frozen_today), \
            ...
            invoice = self.create_invoice(
                ...
                l10n_es_registration_date='2019-01-02',
                invoice_line_ids=[
                    {'price_unit': 100.0, 'tax_ids': [(6, 0, self._get_tax_by_xml_id('p_iva10_bc').ids)]}],
            )
            invoice.action_post()
                ...
                invoice_line_ids=[
                    {
                        'price_unit': 100.0,
                        'tax_ids': [
                            (6, 0, (self._get_tax_by_xml_id('p_iva10_bc') + self._get_tax_by_xml_id('p_req014')).ids)],
                    },
                    {
                        'price_unit': 200.0,
                        'tax_ids': [
                            (6, 0, (self._get_tax_by_xml_id('p_iva21_sc') + self._get_tax_by_xml_id('p_req52')).ids)],
                    },
                ],
            )
            invoice.action_post()
    ...
    def test_120_in_invoice_p_iva21_sp_ex(self):
        ...
        with freeze_time(self.frozen_today), \
            ...
            invoice = self.create_invoice(
                ...
                l10n_es_registration_date='2019-01-02',
                invoice_line_ids=[
                    {'price_unit': 100.0, 'tax_ids': [(6, 0, self._get_tax_by_xml_id('p_iva21_sp_ex').ids)]}],
            )
            invoice.action_post()
                ...
                invoice_line_ids=[
                    {
                        'price_unit': 100.0,
                        'tax_ids': [
                            (6, 0, (self._get_tax_by_xml_id('s_iva10b') + self._get_tax_by_xml_id('s_irpf1')).ids)],
                    },
                ],
            )
            invoice.action_post()
                ...
                invoice_line_ids=[
                    {
                        'price_unit': 100.0,
                        'tax_ids': [
                            (6, 0, (self._get_tax_by_xml_id('p_iva10_bc') + self._get_tax_by_xml_id('p_irpf1')).ids)],
                    },
                ],
            )
            invoice.action_post()
            ...
            self.assertEqual(json_file, {
                ...
                'FacturaRecibida': {
                    ...
                    'DesgloseFactura': {
                        'DesgloseIVA': {
                            'DetalleIVA': [
                                {'BaseImponible': 200.0, 'ImporteCompensacionREAGYP': 24.0,
