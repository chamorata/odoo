...
class AccountJournal(models.Model):
    ...
    l10n_bg_customer_invoice = fields.Selection(string="Customer Invoices",
                                                selection='_l10n_bg_document_type_selection_values', default='01')
    l10n_bg_credit_notes = fields.Selection(string="Credit Notes", selection='_l10n_bg_document_type_selection_values',
                                            default='03')
    l10n_bg_debit_notes = fields.Selection(string="Debit Notes", selection='_l10n_bg_document_type_selection_values',
                                           default='02')
