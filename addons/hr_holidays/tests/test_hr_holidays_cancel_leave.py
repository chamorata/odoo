...
class TestHrHolidaysCancelLeave(TestHrHolidaysCommon):
    ...
    def setUpClass(cls):
        ...
        cls.holiday = cls.env['hr.leave'].with_context(mail_create_nolog=True, mail_notrack=True).with_user(
    ...
    def test_action_cancel_leave_from_another_person(self):
        ...
        self.assertFalse(self.holiday.with_user(self.user_hruser).can_cancel,
