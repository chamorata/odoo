...
class TestReInvoice(TestCommonSaleTimesheet):
    ...
    def test_at_cost(self):
        ...
        self.assertEqual(sale_order_line1.qty_delivered_method, 'timesheet',
                         "Delivered quantity of 'service' SO line should be computed by timesheet amount")
        self.assertEqual(sale_order_line2.qty_delivered_method, 'timesheet',
                         "Delivered quantity of 'service' SO line should be computed by timesheet amount")
        ...
        self.assertEqual(sale_order_line1.qty_delivered, 1,
                         "Exising SO line 1 should not be impacted by reinvoicing product at cost")
        self.assertEqual(sale_order_line2.qty_delivered, 0,
        ...
        self.assertEqual(len(self.sale_order.project_ids), 1,
    ...
    def test_no_expense(self):
        ...
        self.assertEqual(sale_order_line.qty_delivered, 1,
    ...
    def test_project_update_reinvoiced_vendor_bill_product(self):
        ...
        vendor_bill = self.env['account.move'].create({
            ...
            'journal_id': self.env['account.journal'].search(
                [('code', '=', 'BILL'), ('company_id', '=', self.env.company.id)]).id,
        ...
        self.assertTrue(vendor_bill.line_ids.analytic_line_ids,
                        'Analytic line should be created for the account move line')
        self.assertTrue(sale_order.order_line.analytic_line_ids,
