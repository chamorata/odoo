...
class PosConfig(models.Model):
    ...
    iface_discount = fields.Boolean(string='Order Discounts',
    ...
    def _default_discount_value_on_module_install(self):
        ...
        for conf in (configs - open_configs):
            conf.discount_product_id = product if conf.module_pos_discount and product and (
                        not product.company_id or product.company_id == conf.company_id) else False
    ...
    def _get_special_products(self):
        ...
        default_discount_product = self.env.ref('pos_discount.product_product_consumable', raise_if_not_found=False) or \
