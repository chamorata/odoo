...
class TestResetPassword(HttpCase):
    ...
    def test_reset_password(self):
        ...
        self.assertEqual(self.test_user.email, url_parse(
            self.test_user.with_context(create_user=True).partner_id._get_signup_url()).decode_query()["signup_email"],
        ...
        self.assertNotIn("signup_email", url_parse(self.test_user.partner_id._get_signup_url()).decode_query(),
