    ...
    def _compute_l10n_id_product_code(self):
        ...
        for record in self:
            if record.type == 'service':
                record.l10n_id_product_code = self.env.ref('l10n_id_efaktur_coretax.product_code_000000_service',
                                                           raise_if_not_found=False)
            else:
                record.l10n_id_product_code = self.env.ref('l10n_id_efaktur_coretax.product_code_000000_goods',
                                                           raise_if_not_found=False)
