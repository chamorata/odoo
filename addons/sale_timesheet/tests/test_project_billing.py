...
class TestProjectBilling(TestCommonSaleTimesheet):
    ...
    def test_billing_employee_rate(self):
        ...
        self.assertEqual(task.pricing_type, 'employee_rate',
                         "Task in project 'employee rate' should be billed at employee rate")
        self.assertEqual(task.sale_line_id, self.project_employee_rate.sale_line_id,
                         "Task created in a project billed on 'employee rate' should be linked to the SOL defined in the project.")
        self.assertEqual(task.partner_id, task.project_id.partner_id,
                         "Task created in a project billed on 'employee rate' should have the same customer as the one from the project")

        task.write({
                       'sale_line_id': False})  # remove the SOL to check if the timesheet has no SOL when there is no SOL in the task
        ...
        self.assertEqual(self.project_employee_rate_manager.sale_line_id, timesheet1.so_line,
                         "The timesheet should be linked to the SOL associated to the Employee manager in the map")
        self.assertEqual(self.project_employee_rate_manager.project_id, timesheet1.project_id,
        ...
        self.assertFalse(subtask.project_id.allow_billable,
        ...
        self.assertNotEqual(self.project_employee_rate_user.project_id, timesheet2.project_id,
        ...
        self.assertEqual(task.sale_line_id, self.so1_line_deliver_no_task,
        ...
        self.assertTrue(subtask.allow_billable,
        ...
        self.assertFalse(timesheet3.so_line,
        ...
        self.assertFalse(timesheet4.so_line,
    ...
    def test_billing_task_rate(self):
        ...
        self.assertEqual(task.sale_line_id, timesheet1.so_line,
        ...
        self.assertEqual(task.sale_line_id, self.project_task_rate.sale_line_id,
        ...
        self.assertEqual(subtask.sale_line_id, subtask.parent_id.sale_line_id,
        ...
        self.assertEqual(subtask.partner_id, subtask.parent_id.partner_id,
    ...
    def test_customer_change_in_project(self):
        ...
        # 2.1) Check if the SOL in mapping is also equal to False
        self.assertFalse(self.project_employee_rate_manager.sale_line_id,
                         "The SOL in the mapping should be False because the actual customer in the project has not this SOL.")
        self.assertFalse(self.project_employee_rate_user.sale_line_id,
                         "The SOL in the mapping should be False because the actual customer in the project has not this SOL.")
    ...
    def test_project_form_view(self):
        ...
        with Form(self.env['project.project']) as project_form:
            ...
            self.assertEqual(project_form.partner_id, self.so.partner_id,
