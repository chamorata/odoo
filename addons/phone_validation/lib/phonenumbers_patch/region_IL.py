...
PHONE_METADATA_IL = PhoneMetadata(id='IL', country_code=972, international_prefix='0(?:0|1[2-9])',
                                  ...
                                  uan=PhoneNumberDesc(national_number_pattern='1599\\d{6}', example_number='1599123456',
                                                      possible_length=(10,)),
                                  ...
                                  number_format=[NumberFormat(pattern='(\\d{4})(\\d{3})', format='\\1-\\2',
                                                 ...
                                                 NumberFormat(pattern='(\\d{3})(\\d{1,2})(\\d{3})(\\d{4})',
                                                              format='\\1-\\2 \\3-\\4', leading_digits_pattern=['15'])],
