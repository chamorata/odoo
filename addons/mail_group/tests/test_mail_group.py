...
class TestMailGroup(TestMailListCommon):
    ...
    def test_clean_email_body(self):
        footer = self.env['ir.qweb']._render('mail_group.mail_group_footer', {'group_url': 'Test remove footer'},
    ...
    def test_find_group_user_for_alias(self):
        ...
        group_user_not_member = mail_new_test_user(self.env, login='group user not member',
        ...
        err_msg = self.test_group._alias_get_error({}, {'email_from': group_user_not_member.email},
