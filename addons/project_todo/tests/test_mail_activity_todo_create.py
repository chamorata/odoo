...
class TestMailActivityTodo(TransactionCase):
    ...
    def test_create_todo_activity(self):
        ...
        self.assertEqual(todo_1.description, Markup('<p>details</p>'),
        ...
        self.assertEqual(activity_1.date_deadline, todo_1.date_deadline.date(),
                         'The Todo and The Activity should have the same date deadline')
