...
class TaxReportTest(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.tax_report_line_2_6 = cls._create_basic_tax_report_line(cls.tax_report_2, "Line 100, but in report 2",
                                                                    '100')
    ...
    def test_create_shared_tags(self):
        self.assertEqual(len(self._get_tax_tags(self.test_country_1, tag_name='01')), 2,
    ...
    def test_write_single_line_tagname_not_shared(self):
        ...
        self.assertEqual(len(self._get_tax_tags(self.test_country_1, tag_name=original_tag_name)), 0,
        ...
        self.assertEqual(len(self._get_tax_tags(self.test_country_1)), len(start_tags),
    ...
    def test_write_single_line_tagname_shared(self):
        ...
        self.assertEqual(self._get_tax_tags(self.test_country_1, tag_name=original_tag_name), original_tags,
                         "The original tags should be unchanged")
        self.assertEqual(len(self._get_tax_tags(self.test_country_1)), len(start_tags) + 2,
    ...
    def test_edit_multi_line_tagname_all_different_new(self):
        ...
        self.assertTrue(line_1_1_tags == line_2_2_tags == line_2_42_tags,
    ...
    def test_tax_report_change_country(self):
        ...
        self.assertEqual(country_1_tags_before_copy, country_1_tags_after_copy,
        ...
        self.assertEqual(country_1_tags_after_change, country_1_tags_after_copy,
                         "Modifying the country should not have changed the tags in the original country.")
        self.assertEqual(len(country_2_tags_after_change),
        ...
        for original, copy in zip(self.tax_report_1.line_ids, copied_report_1.line_ids):
            ...
            self.assertNotEqual(original_tags, copy_tags,
                                "Tags matched by original and copied expressions should now be different.")
            self.assertEqual(set(original_tags.mapped('name')), set(copy_tags.mapped('name')),
                             "Tags matched by original and copied expression should have the same names.")
            self.assertNotEqual(original_tags.country_id, copy_tags.country_id,
        ...
        for line in self.tax_report_2.line_ids:
            ...
            if line == self.tax_report_line_2_42:
                ...
                self.assertEqual(line_tags, original_report_2_tags[line],
                ...
                for tag in line_tags:
                    self.assertIn(tag, country_2_tags_after_change,
    ...
    def test_unlink_report_line_tags_used_by_other_expression(self):
        ...
        self.assertEqual(len(tags_after), len(tags_before),
                         "Unlinking a report expression whose tags are used by another expression should not delete them.")
        self.assertEqual(len(tags_archived_after), len(tags_archived_before),
    ...
    def test_tag_recreation_archived(self):
        ...
        self.assertEqual(tags_after.mapped('name'), ['+' + tag_name, '-' + tag_name],
