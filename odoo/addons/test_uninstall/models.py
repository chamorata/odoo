...
class ResUsers(models.Model):
    ...
    _sql_constraints = [
        ...
        ('test_uninstall_res_user_exclude_constraint', 'exclude (password with =)',
         'Test uninstall exclude constraint'),
        ('test_uninstall_res_user_exclude_constraint_looooooooooooong_name', 'exclude (password with =)',
         'Test uninstall exclude constraint'),
    ]
